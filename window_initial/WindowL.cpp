...
void WindowManager::SetSize(uint32 width, uint32 height)
{
    mWidth = width;
    mHeight = height;
...
void WindowManager::MouseDown(uint32 button, int x, int y)
{
...
void WindowManager::MouseUp(uint32 button)
{
...
void WindowManager::GetSize(uint32& Width, uint32& Height) const
{
    Width = mWidth;
    Height = mHeight;
}
...
bool WindowManager::IsMouseButtonDown(uint32 button) const
{
...
void WindowManager::OnResize(uint32 width, uint32 height)
{
    (void)width;
    (void)height;
}
...
void WindowManager::OnMouseDown(uint32 button, int x, int y)
{
    (void)button;
    (void)x;
    (void)y;
...
void WindowManager::OnMouseUp(uint32 button)
{
    (void)button;
}
