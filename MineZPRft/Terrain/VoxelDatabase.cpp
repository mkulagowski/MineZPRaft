 ...
 * @brief  Voxel Database definitions.
 */

#include "VoxelDatabase.hpp"

/**
 * Statically generated Voxel Database.
 *
 * Maps two values - VoxelType Enum to a Voxel struct. All elements should be accessed by using
 * a VoxelType enum as a key to a map.
 */
